...
const Hero = () => {
   return (
      <section className="">
         <div className="p-initial border-b border-black px-container-base pb-2 pt-10 font-[400] lg:px-container-lg xl:px-container-xl">
            <h2 className="text-5xl">Science</h2>
         </div>
         <div className="mt-10 flex flex-col gap-6 px-container-base lg:px-container-lg xl:px-container-xl">
            <h4 className="text-xl font-[700]">Highlight</h4>
